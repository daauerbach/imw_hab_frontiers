...
# regression with stream-level intercepts & slopes, AR1 within stream
# unfortunately equatiomatic not extended to brms yet
...
#add plot as list col, keeping separate mutate to not re-add draws if plotting tweaks
strm_year_meas_mean_pp_gg <- strm_year_meas_mean_pp |> 
  mutate(
    meas_gg = case_when(
...
## do estimates of year effects (slope) for treatment streams differ from reference stream?
