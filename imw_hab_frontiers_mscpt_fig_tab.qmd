...
While streams shared a general pattern of within-network differences in the magnitude of temporal variation, and although various individual sites showed appreciable interannual change, consistent directional change was rarely detectable in time series of habitat measures summarized across sites per year to a 'whole-stream' average (Table TRND, Figure TRND).

[add specifics]

trend statistics demonstrate prevailing lack of consistent, directional change	
