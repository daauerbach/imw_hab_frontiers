...
With the focus on whether and how treatment stream observations detectably diverged from those in reference streams, we regressed the whole stream annual habitat measures against year, fitting Bayesian multilevel models per complex of measure against the stream-year interaction, with intercept and slope random effects per stream and with AR(1) autocorrelation in the year (R version 4.5.1, R Core Team 2025; package `brms` 2.23.0, Bürkner 2017). The proportion gravel and pools were specified with a beta family, a lognormal was used for the remaining (positive, real) measures, and all models used relatively uninformative priors. Models converged well with 3000 iterations on 4 chains with good Rhat and effective sample size diagnostic values.

R Core Team (2025). _R: A Language and Environment for Statistical Computing_. R Foundation for Statistical Computing, Vienna, Austria. <https://www.R-project.org/>.

Bürkner (2017). brms: An R Package for Bayesian Multilevel Models Using Stan. Journal of Statistical Software, 80(1), 1-28. doi:10.18637/jss.v080.i01
...
$$ \operatorname{measure} = \alpha + \beta_{trtmnt-stream_i} + \beta_{ref-stream}(\operatorname{year}) + \beta_{trtmnt-stream_i}(\operatorname{stream} \times \operatorname{year}) + \epsilon $$
